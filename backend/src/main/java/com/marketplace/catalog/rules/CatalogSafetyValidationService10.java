...
@Slf4j
@Service
public class CatalogSafetyValidationService10 {

    public CatalogComplianceRule10 validateProduct(Product product) {
        boolean clean = product.getTitle() != null && !product.getTitle().toLowerCase().contains("prohibited");
        return CatalogComplianceRule10.builder()
                .product(product)
                .ruleType("SAFETY_COMPLIANCE_STANDARDS_10")
