...
@Slf4j
@Service
public class CatalogSafetyValidationService17 {

    public CatalogComplianceRule17 validateProduct(Product product) {
        boolean clean = product.getTitle() != null && !product.getTitle().toLowerCase().contains("prohibited");
        return CatalogComplianceRule17.builder()
                .product(product)
                .ruleType("SAFETY_COMPLIANCE_STANDARDS_17")
