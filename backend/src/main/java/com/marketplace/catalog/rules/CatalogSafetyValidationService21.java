...
@Slf4j
@Service
public class CatalogSafetyValidationService21 {

    public CatalogComplianceRule21 validateProduct(Product product) {
        boolean clean = product.getTitle() != null && !product.getTitle().toLowerCase().contains("prohibited");
        return CatalogComplianceRule21.builder()
                .product(product)
                .ruleType("SAFETY_COMPLIANCE_STANDARDS_21")
