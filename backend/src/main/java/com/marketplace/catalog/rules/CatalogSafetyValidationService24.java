...
@Slf4j
@Service
public class CatalogSafetyValidationService24 {

    public CatalogComplianceRule24 validateProduct(Product product) {
        boolean clean = product.getTitle() != null && !product.getTitle().toLowerCase().contains("prohibited");
        return CatalogComplianceRule24.builder()
                .product(product)
                .ruleType("SAFETY_COMPLIANCE_STANDARDS_24")
