...
@Slf4j
@Service
public class CatalogSafetyValidationService27 {

    public CatalogComplianceRule27 validateProduct(Product product) {
        boolean clean = product.getTitle() != null && !product.getTitle().toLowerCase().contains("prohibited");
        return CatalogComplianceRule27.builder()
                .product(product)
                .ruleType("SAFETY_COMPLIANCE_STANDARDS_27")
