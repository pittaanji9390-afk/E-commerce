...
@Slf4j
@Service
public class CatalogSafetyValidationService31 {

    public CatalogComplianceRule31 validateProduct(Product product) {
        boolean clean = product.getTitle() != null && !product.getTitle().toLowerCase().contains("prohibited");
        return CatalogComplianceRule31.builder()
                .product(product)
                .ruleType("SAFETY_COMPLIANCE_STANDARDS_31")
