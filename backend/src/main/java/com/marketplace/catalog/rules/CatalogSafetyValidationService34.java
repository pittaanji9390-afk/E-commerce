...
@Slf4j
@Service
public class CatalogSafetyValidationService34 {

    public CatalogComplianceRule34 validateProduct(Product product) {
        boolean clean = product.getTitle() != null && !product.getTitle().toLowerCase().contains("prohibited");
        return CatalogComplianceRule34.builder()
                .product(product)
                .ruleType("SAFETY_COMPLIANCE_STANDARDS_34")
