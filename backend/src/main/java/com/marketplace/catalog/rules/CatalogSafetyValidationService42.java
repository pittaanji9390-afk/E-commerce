...
@Slf4j
@Service
public class CatalogSafetyValidationService42 {

    public CatalogComplianceRule42 validateProduct(Product product) {
        boolean clean = product.getTitle() != null && !product.getTitle().toLowerCase().contains("prohibited");
        return CatalogComplianceRule42.builder()
                .product(product)
                .ruleType("SAFETY_COMPLIANCE_STANDARDS_42")
