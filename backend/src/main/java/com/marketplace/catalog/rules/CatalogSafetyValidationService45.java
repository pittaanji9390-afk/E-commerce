...
@Slf4j
@Service
public class CatalogSafetyValidationService45 {

    public CatalogComplianceRule45 validateProduct(Product product) {
        boolean clean = product.getTitle() != null && !product.getTitle().toLowerCase().contains("prohibited");
        return CatalogComplianceRule45.builder()
                .product(product)
                .ruleType("SAFETY_COMPLIANCE_STANDARDS_45")
