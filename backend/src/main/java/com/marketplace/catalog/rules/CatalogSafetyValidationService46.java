...
@Slf4j
@Service
public class CatalogSafetyValidationService46 {

    public CatalogComplianceRule46 validateProduct(Product product) {
        boolean clean = product.getTitle() != null && !product.getTitle().toLowerCase().contains("prohibited");
        return CatalogComplianceRule46.builder()
                .product(product)
                .ruleType("SAFETY_COMPLIANCE_STANDARDS_46")
