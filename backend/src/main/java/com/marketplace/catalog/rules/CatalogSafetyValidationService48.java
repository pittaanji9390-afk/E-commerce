...
@Slf4j
@Service
public class CatalogSafetyValidationService48 {

    public CatalogComplianceRule48 validateProduct(Product product) {
        boolean clean = product.getTitle() != null && !product.getTitle().toLowerCase().contains("prohibited");
        return CatalogComplianceRule48.builder()
                .product(product)
                .ruleType("SAFETY_COMPLIANCE_STANDARDS_48")
