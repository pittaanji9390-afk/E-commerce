...
@Slf4j
@Service
public class CatalogSafetyValidationService49 {

    public CatalogComplianceRule49 validateProduct(Product product) {
        boolean clean = product.getTitle() != null && !product.getTitle().toLowerCase().contains("prohibited");
        return CatalogComplianceRule49.builder()
                .product(product)
                .ruleType("SAFETY_COMPLIANCE_STANDARDS_49")
