...
@Slf4j
@Service
public class FifoCostCalculationService1 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord1> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord1 batch : fifoQueue) {
