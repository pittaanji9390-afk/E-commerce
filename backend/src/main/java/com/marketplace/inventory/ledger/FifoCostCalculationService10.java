...
@Slf4j
@Service
public class FifoCostCalculationService10 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord10> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord10 batch : fifoQueue) {
