...
@Slf4j
@Service
public class FifoCostCalculationService11 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord11> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord11 batch : fifoQueue) {
