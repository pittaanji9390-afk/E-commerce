...
@Slf4j
@Service
public class FifoCostCalculationService13 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord13> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord13 batch : fifoQueue) {
