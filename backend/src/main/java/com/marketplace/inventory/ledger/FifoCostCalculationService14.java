...
@Slf4j
@Service
public class FifoCostCalculationService14 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord14> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord14 batch : fifoQueue) {
