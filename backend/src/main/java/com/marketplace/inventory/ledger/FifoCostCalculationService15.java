...
@Slf4j
@Service
public class FifoCostCalculationService15 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord15> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord15 batch : fifoQueue) {
