...
@Slf4j
@Service
public class FifoCostCalculationService16 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord16> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord16 batch : fifoQueue) {
