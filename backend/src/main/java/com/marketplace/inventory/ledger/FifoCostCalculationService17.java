...
@Slf4j
@Service
public class FifoCostCalculationService17 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord17> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord17 batch : fifoQueue) {
