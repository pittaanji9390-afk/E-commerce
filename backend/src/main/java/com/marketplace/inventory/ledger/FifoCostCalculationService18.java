...
@Slf4j
@Service
public class FifoCostCalculationService18 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord18> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord18 batch : fifoQueue) {
