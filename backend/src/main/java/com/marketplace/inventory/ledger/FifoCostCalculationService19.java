...
@Slf4j
@Service
public class FifoCostCalculationService19 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord19> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord19 batch : fifoQueue) {
