...
@Slf4j
@Service
public class FifoCostCalculationService2 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord2> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord2 batch : fifoQueue) {
