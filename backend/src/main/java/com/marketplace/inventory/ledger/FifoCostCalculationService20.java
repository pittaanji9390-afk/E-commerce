...
@Slf4j
@Service
public class FifoCostCalculationService20 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord20> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord20 batch : fifoQueue) {
