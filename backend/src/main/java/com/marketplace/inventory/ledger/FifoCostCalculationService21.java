...
@Slf4j
@Service
public class FifoCostCalculationService21 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord21> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord21 batch : fifoQueue) {
