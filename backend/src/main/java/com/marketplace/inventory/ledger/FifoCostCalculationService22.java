...
@Slf4j
@Service
public class FifoCostCalculationService22 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord22> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord22 batch : fifoQueue) {
