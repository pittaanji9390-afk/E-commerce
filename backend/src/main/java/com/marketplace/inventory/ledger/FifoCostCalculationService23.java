...
@Slf4j
@Service
public class FifoCostCalculationService23 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord23> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord23 batch : fifoQueue) {
