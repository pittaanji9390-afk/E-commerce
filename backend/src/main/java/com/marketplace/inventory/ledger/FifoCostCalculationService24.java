...
@Slf4j
@Service
public class FifoCostCalculationService24 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord24> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord24 batch : fifoQueue) {
