...
@Slf4j
@Service
public class FifoCostCalculationService26 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord26> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord26 batch : fifoQueue) {
