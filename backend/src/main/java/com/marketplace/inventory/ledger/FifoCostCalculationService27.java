...
@Slf4j
@Service
public class FifoCostCalculationService27 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord27> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord27 batch : fifoQueue) {
