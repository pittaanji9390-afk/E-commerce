...
@Slf4j
@Service
public class FifoCostCalculationService28 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord28> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord28 batch : fifoQueue) {
