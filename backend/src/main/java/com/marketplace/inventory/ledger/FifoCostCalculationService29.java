...
@Slf4j
@Service
public class FifoCostCalculationService29 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord29> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord29 batch : fifoQueue) {
