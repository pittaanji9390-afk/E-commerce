...
@Slf4j
@Service
public class FifoCostCalculationService3 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord3> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord3 batch : fifoQueue) {
