...
@Slf4j
@Service
public class FifoCostCalculationService30 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord30> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord30 batch : fifoQueue) {
