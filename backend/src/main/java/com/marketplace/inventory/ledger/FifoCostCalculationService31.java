...
@Slf4j
@Service
public class FifoCostCalculationService31 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord31> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord31 batch : fifoQueue) {
