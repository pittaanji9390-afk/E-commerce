...
@Slf4j
@Service
public class FifoCostCalculationService32 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord32> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord32 batch : fifoQueue) {
