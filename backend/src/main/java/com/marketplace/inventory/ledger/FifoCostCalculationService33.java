...
@Slf4j
@Service
public class FifoCostCalculationService33 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord33> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord33 batch : fifoQueue) {
