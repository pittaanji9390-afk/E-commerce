...
@Slf4j
@Service
public class FifoCostCalculationService34 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord34> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord34 batch : fifoQueue) {
