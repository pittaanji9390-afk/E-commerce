...
@Slf4j
@Service
public class FifoCostCalculationService36 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord36> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord36 batch : fifoQueue) {
