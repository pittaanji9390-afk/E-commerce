...
@Slf4j
@Service
public class FifoCostCalculationService37 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord37> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord37 batch : fifoQueue) {
