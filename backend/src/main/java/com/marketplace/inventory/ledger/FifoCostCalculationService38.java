...
@Slf4j
@Service
public class FifoCostCalculationService38 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord38> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord38 batch : fifoQueue) {
