...
@Slf4j
@Service
public class FifoCostCalculationService39 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord39> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord39 batch : fifoQueue) {
