...
@Slf4j
@Service
public class FifoCostCalculationService4 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord4> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord4 batch : fifoQueue) {
