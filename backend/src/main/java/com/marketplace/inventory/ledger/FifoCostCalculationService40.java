...
@Slf4j
@Service
public class FifoCostCalculationService40 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord40> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord40 batch : fifoQueue) {
