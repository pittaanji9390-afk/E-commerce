...
@Slf4j
@Service
public class FifoCostCalculationService41 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord41> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord41 batch : fifoQueue) {
