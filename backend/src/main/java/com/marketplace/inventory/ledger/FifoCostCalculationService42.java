...
@Slf4j
@Service
public class FifoCostCalculationService42 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord42> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord42 batch : fifoQueue) {
