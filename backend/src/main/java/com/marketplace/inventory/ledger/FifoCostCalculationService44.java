...
@Slf4j
@Service
public class FifoCostCalculationService44 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord44> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord44 batch : fifoQueue) {
