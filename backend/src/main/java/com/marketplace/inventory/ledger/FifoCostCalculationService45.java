...
@Slf4j
@Service
public class FifoCostCalculationService45 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord45> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord45 batch : fifoQueue) {
