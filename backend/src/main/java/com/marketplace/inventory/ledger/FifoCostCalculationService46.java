...
@Slf4j
@Service
public class FifoCostCalculationService46 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord46> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord46 batch : fifoQueue) {
