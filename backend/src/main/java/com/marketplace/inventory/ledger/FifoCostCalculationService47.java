...
@Slf4j
@Service
public class FifoCostCalculationService47 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord47> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord47 batch : fifoQueue) {
