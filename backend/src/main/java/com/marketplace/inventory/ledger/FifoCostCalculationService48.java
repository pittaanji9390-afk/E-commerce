...
@Slf4j
@Service
public class FifoCostCalculationService48 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord48> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord48 batch : fifoQueue) {
