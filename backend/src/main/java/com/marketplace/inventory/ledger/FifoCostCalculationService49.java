...
@Slf4j
@Service
public class FifoCostCalculationService49 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord49> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord49 batch : fifoQueue) {
