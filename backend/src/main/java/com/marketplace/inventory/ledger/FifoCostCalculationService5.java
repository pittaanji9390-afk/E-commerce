...
@Slf4j
@Service
public class FifoCostCalculationService5 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord5> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord5 batch : fifoQueue) {
