...
@Slf4j
@Service
public class FifoCostCalculationService50 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord50> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord50 batch : fifoQueue) {
