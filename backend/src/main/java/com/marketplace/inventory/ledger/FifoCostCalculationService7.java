...
@Slf4j
@Service
public class FifoCostCalculationService7 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord7> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord7 batch : fifoQueue) {
