...
@Slf4j
@Service
public class FifoCostCalculationService8 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord8> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord8 batch : fifoQueue) {
