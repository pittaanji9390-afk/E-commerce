...
@Slf4j
@Service
public class FifoCostCalculationService9 {

    public BigDecimal calculateCostOfGoodsSold(List<InventoryFifoValuationRecord9> fifoQueue, int quantitySold) {
        BigDecimal totalCogs = BigDecimal.ZERO;
        int remainingToFulfill = quantitySold;

        for (InventoryFifoValuationRecord9 batch : fifoQueue) {
