...
@Slf4j
@Service
public class BadgeEvaluationService1 {

    public SellerTierCertification1 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification1 badge = SellerTierCertification1.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_1")
