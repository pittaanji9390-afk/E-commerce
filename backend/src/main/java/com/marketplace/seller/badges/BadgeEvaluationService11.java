...
@Slf4j
@Service
public class BadgeEvaluationService11 {

    public SellerTierCertification11 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification11 badge = SellerTierCertification11.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_11")
