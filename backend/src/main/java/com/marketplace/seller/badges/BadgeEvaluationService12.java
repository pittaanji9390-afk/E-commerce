...
@Slf4j
@Service
public class BadgeEvaluationService12 {

    public SellerTierCertification12 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification12 badge = SellerTierCertification12.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_12")
