...
@Slf4j
@Service
public class BadgeEvaluationService13 {

    public SellerTierCertification13 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification13 badge = SellerTierCertification13.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_13")
