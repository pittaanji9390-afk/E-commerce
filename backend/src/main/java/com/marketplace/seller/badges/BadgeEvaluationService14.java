...
@Slf4j
@Service
public class BadgeEvaluationService14 {

    public SellerTierCertification14 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification14 badge = SellerTierCertification14.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_14")
