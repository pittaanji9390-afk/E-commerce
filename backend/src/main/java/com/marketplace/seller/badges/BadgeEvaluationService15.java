...
@Slf4j
@Service
public class BadgeEvaluationService15 {

    public SellerTierCertification15 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification15 badge = SellerTierCertification15.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_15")
