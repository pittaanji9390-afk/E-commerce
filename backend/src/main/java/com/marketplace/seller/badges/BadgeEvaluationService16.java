...
@Slf4j
@Service
public class BadgeEvaluationService16 {

    public SellerTierCertification16 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification16 badge = SellerTierCertification16.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_16")
