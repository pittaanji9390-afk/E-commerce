...
@Slf4j
@Service
public class BadgeEvaluationService17 {

    public SellerTierCertification17 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification17 badge = SellerTierCertification17.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_17")
