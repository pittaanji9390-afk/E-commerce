...
@Slf4j
@Service
public class BadgeEvaluationService19 {

    public SellerTierCertification19 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification19 badge = SellerTierCertification19.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_19")
