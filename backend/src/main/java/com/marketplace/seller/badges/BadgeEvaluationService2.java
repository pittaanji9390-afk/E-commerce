...
@Slf4j
@Service
public class BadgeEvaluationService2 {

    public SellerTierCertification2 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification2 badge = SellerTierCertification2.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_2")
