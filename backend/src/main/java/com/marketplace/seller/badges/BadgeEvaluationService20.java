...
@Slf4j
@Service
public class BadgeEvaluationService20 {

    public SellerTierCertification20 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification20 badge = SellerTierCertification20.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_20")
