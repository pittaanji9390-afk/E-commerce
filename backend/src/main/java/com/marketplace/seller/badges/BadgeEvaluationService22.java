...
@Slf4j
@Service
public class BadgeEvaluationService22 {

    public SellerTierCertification22 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification22 badge = SellerTierCertification22.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_22")
