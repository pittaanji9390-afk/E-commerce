...
@Slf4j
@Service
public class BadgeEvaluationService23 {

    public SellerTierCertification23 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification23 badge = SellerTierCertification23.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_23")
