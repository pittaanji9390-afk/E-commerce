...
@Slf4j
@Service
public class BadgeEvaluationService24 {

    public SellerTierCertification24 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification24 badge = SellerTierCertification24.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_24")
