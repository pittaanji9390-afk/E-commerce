...
@Slf4j
@Service
public class BadgeEvaluationService25 {

    public SellerTierCertification25 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification25 badge = SellerTierCertification25.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_25")
