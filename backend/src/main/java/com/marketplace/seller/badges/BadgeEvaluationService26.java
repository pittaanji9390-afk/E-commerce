...
@Slf4j
@Service
public class BadgeEvaluationService26 {

    public SellerTierCertification26 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification26 badge = SellerTierCertification26.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_26")
