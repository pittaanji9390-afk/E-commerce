...
@Slf4j
@Service
public class BadgeEvaluationService27 {

    public SellerTierCertification27 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification27 badge = SellerTierCertification27.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_27")
