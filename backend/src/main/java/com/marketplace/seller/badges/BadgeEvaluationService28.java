...
@Slf4j
@Service
public class BadgeEvaluationService28 {

    public SellerTierCertification28 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification28 badge = SellerTierCertification28.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_28")
