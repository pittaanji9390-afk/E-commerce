...
@Slf4j
@Service
public class BadgeEvaluationService29 {

    public SellerTierCertification29 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification29 badge = SellerTierCertification29.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_29")
