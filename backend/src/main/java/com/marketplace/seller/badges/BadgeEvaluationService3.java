...
@Slf4j
@Service
public class BadgeEvaluationService3 {

    public SellerTierCertification3 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification3 badge = SellerTierCertification3.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_3")
