...
@Slf4j
@Service
public class BadgeEvaluationService31 {

    public SellerTierCertification31 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification31 badge = SellerTierCertification31.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_31")
