...
@Slf4j
@Service
public class BadgeEvaluationService32 {

    public SellerTierCertification32 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification32 badge = SellerTierCertification32.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_32")
