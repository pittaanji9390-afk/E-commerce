...
@Slf4j
@Service
public class BadgeEvaluationService33 {

    public SellerTierCertification33 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification33 badge = SellerTierCertification33.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_33")
