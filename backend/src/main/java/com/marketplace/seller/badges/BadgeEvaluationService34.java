...
@Slf4j
@Service
public class BadgeEvaluationService34 {

    public SellerTierCertification34 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification34 badge = SellerTierCertification34.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_34")
