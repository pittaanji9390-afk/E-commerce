...
@Slf4j
@Service
public class BadgeEvaluationService36 {

    public SellerTierCertification36 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification36 badge = SellerTierCertification36.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_36")
