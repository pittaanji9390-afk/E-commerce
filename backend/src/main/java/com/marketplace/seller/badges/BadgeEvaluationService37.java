...
@Slf4j
@Service
public class BadgeEvaluationService37 {

    public SellerTierCertification37 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification37 badge = SellerTierCertification37.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_37")
