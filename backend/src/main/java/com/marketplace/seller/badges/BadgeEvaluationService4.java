...
@Slf4j
@Service
public class BadgeEvaluationService4 {

    public SellerTierCertification4 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification4 badge = SellerTierCertification4.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_4")
