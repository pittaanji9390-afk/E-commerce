...
@Slf4j
@Service
public class BadgeEvaluationService40 {

    public SellerTierCertification40 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification40 badge = SellerTierCertification40.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_40")
