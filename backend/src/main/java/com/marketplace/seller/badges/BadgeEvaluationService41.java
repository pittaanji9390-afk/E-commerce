...
@Slf4j
@Service
public class BadgeEvaluationService41 {

    public SellerTierCertification41 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification41 badge = SellerTierCertification41.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_41")
