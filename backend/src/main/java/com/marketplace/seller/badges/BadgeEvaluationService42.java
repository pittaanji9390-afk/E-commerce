...
@Slf4j
@Service
public class BadgeEvaluationService42 {

    public SellerTierCertification42 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification42 badge = SellerTierCertification42.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_42")
