...
@Slf4j
@Service
public class BadgeEvaluationService43 {

    public SellerTierCertification43 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification43 badge = SellerTierCertification43.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_43")
