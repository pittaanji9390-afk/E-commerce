...
@Slf4j
@Service
public class BadgeEvaluationService45 {

    public SellerTierCertification45 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification45 badge = SellerTierCertification45.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_45")
