...
@Slf4j
@Service
public class BadgeEvaluationService46 {

    public SellerTierCertification46 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification46 badge = SellerTierCertification46.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_46")
