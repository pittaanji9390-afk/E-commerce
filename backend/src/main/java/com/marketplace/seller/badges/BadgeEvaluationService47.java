...
@Slf4j
@Service
public class BadgeEvaluationService47 {

    public SellerTierCertification47 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification47 badge = SellerTierCertification47.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_47")
