...
@Slf4j
@Service
public class BadgeEvaluationService48 {

    public SellerTierCertification48 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification48 badge = SellerTierCertification48.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_48")
