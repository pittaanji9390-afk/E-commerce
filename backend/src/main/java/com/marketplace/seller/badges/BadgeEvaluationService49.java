...
@Slf4j
@Service
public class BadgeEvaluationService49 {

    public SellerTierCertification49 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification49 badge = SellerTierCertification49.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_49")
