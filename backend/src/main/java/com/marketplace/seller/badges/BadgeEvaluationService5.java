...
@Slf4j
@Service
public class BadgeEvaluationService5 {

    public SellerTierCertification5 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification5 badge = SellerTierCertification5.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_5")
