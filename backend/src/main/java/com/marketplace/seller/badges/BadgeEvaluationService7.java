...
@Slf4j
@Service
public class BadgeEvaluationService7 {

    public SellerTierCertification7 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification7 badge = SellerTierCertification7.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_7")
