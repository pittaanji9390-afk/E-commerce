...
@Slf4j
@Service
public class BadgeEvaluationService8 {

    public SellerTierCertification8 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification8 badge = SellerTierCertification8.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_8")
