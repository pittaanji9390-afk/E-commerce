...
@Slf4j
@Service
public class BadgeEvaluationService9 {

    public SellerTierCertification9 evaluateBadge(Seller seller, double onTimeRate, double rating) {
        boolean qualifies = onTimeRate >= 0.95 && rating >= 4.7;
        SellerTierCertification9 badge = SellerTierCertification9.builder()
                .seller(seller)
                .badgeName("PREMIER_SELLER_LEVEL_9")
