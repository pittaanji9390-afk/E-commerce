...
export const SellerPerformanceMetricTab30: React.FC = () => {
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm space-y-6">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h3 className="text-base font-bold text-gray-900 flex items-center gap-2">
            <TrendingUp className="w-5 h-5 text-primary-600" /> Operational Efficiency Matrix #30
          </h3>
          <p className="text-xs text-gray-500 mt-1">Fulfillment speed, defect rates, and dispute resolution metrics.</p>
        </div>
        <span className="text-xs font-semibold text-primary-600 bg-primary-50 px-2.5 py-1 rounded-md">Metric Suite #30</span>
      </div>
